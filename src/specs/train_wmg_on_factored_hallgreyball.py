...
LOAD_MODEL_FROM = models/new_wmg_factored_roomgreyball.pth
SAVE_MODELS_TO = models/new_wmg_factored_hallgreyball.pth
...
# BabyAI_Env
BABYAI_ENV_LEVEL = BabyAI-HallGreyBall-v0
